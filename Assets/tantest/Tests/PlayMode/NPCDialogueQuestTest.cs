...
public class NPCDialogueQuestTest
{
    ...
    public IEnumerator RunNPCDialogueQuestLineMultipleTimes()
    {
        ...
        // Tìm 3 NPC trong scene d?a trên npcID c?a h?
        ...
        for (int run = 1; run <= 3; run++)
        {
            ...
            // =========================================================================
            // BU?C 1: Nói chuy?n v?i Prince d? nh?n nhi?m v? gi?t skeleton (LEVEL UP!!!!)
            // =========================================================================
            ...
            // Ki?m tra: Player dã nh?n quest 6 (KIll ske) chua
            ...
            // =========================================================================
            // BU?C 2: Tiêu di?t 2 Skeletons và quay l?i Prince
            // =========================================================================
            ...
            // Nói chuy?n v?i Prince d? tr? quest 6 và t? d?ng nh?n quest 8 (KILL ORC KING)
            ...
            // =========================================================================
            // BU?C 3: Tiêu di?t Orc King và quay l?i Prince
            // =========================================================================
            ...
            // Nói chuy?n v?i Prince d? tr? quest 8 và t? d?ng nh?n quest 11 (FIND THE KING)
            ...
            // =========================================================================
            // BU?C 4: Ð?n lâu dài và nói chuy?n v?i King
            // =========================================================================
            ...
            // =========================================================================
            // BU?C 5: Ð?t c?p d? 10 và quay l?i King
            // =========================================================================
            ...
            // Nói chuy?n v?i King d? tr? quest 17 và nh?n quest 12 (DEFEAT KNIGHT HERO)
            ...
            // =========================================================================
            // BU?C 6: Tiêu di?t Knight Hero và quay l?i King
            // =========================================================================
            ...
            // Nói chuy?n v?i King d? tr? quest 12 và nh?n quest 13 (Find The Master)
            ...
            // =========================================================================
            // BU?C 8: Thu th?p 20 qu?ng và quay l?i Wizard
            // =========================================================================
            ...
            // Nói chuy?n v?i Wizard d? tr? quest 16 và nh?n quest 18 (Craft 10 Potions)
            ...
            // =========================================================================
            // BU?C 9: Ch? t?o 10 bình máu và quay l?i Wizard
            // =========================================================================
            // Debug.Log("[TEST] Step 9: Simulating crafting 10 potions...");
            // Xóa qu?ng và d?t potion vào túi d? d? vu?t qua bu?c CheckTienDo c?a GiaoVatPham n?u có,
            // Ð?ng th?i tang ti?n d? c?a nhi?m v? ch? t?o (LoaiNhiemVu.CheTao = 6, Potion ID = 1001)
            ...
            // Nói chuy?n v?i Wizard d? tr? quest 18 và nh?n quest 15 (THE END)
            ...
            // =========================================================================
            // BU?C 10: Tiêu di?t Boss Cu?i (Final Boss) và quay l?i Wizard
            // =========================================================================
            ...
            // Nói chuy?n v?i Wizard d? tr? quest 15
    ...
    // Helper: Ki?m tra xem nhi?m v? c? th? dã d?t yêu c?u chua
    ...
    private IEnumerator SimulateDialogueChoice()
    {
        ...
        while ((bool)Refl.GetField(convManagerInstance, "IsConversationActive") && timer < 10f)
        {
            ...
            if ((int)state == 3)
            {
                ...
                {
                    // N?u không có danh sách l?a ch?n, tìm xem có button Speech (Continue) hay End trong Scene không và click nó
